...
/* Keil.MDK-Plus::File System:Drive:Memory Card:6.15.0 */
...
/* Keil.MDK-Plus::USB:Device:MSC:6.16.0 */
...
/* Keil::CMSIS Driver:USB Device:Full-speed:2.22 */
...
/* Keil::Device:STM32Cube HAL:QSPI:1.7.13 */
