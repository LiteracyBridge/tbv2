...
#define LOG_AUDIO_PLAY_WAVE(filename, lenMs, lenBytes, samplesPerSec, isMono) \
          logEvtFmt(AUDIO_EVENT, "wave_file: '%s', length_ms: %d, size: %d, samples/sec: %d, isMono: %s", \
              filename, lenMs, lenBytes, samplesPerSec, isMono?"t":"f")

#define LOG_AUDIO_PLAY_STOP(lenMs, playedMs, playedPct, iSubj, iMsg) \
        logEvtFmt(AUDIO_EVENT, "evt: stop, length_ms: %d, played_ms: %d, completion%%: %d, Subj:%d, Msg:%d", lenMs, playedMs, playedPct, iSubj, iMsg )

#define LOG_AUDIO_PLAY_PAUSE(lenMs, playedMs, playedPct) \
          logEvtFmt(AUDIO_EVENT, "evt: pause, length_ms: %d, played_ms: %d, completion%%: %d", lenMs, playedMs, playedPct)

#define LOG_AUDIO_PLAY_RESUME(lenMs, playedMs, playedPct) \
          logEvtFmt(AUDIO_EVENT, "evt: resume, length_ms: %d, played_ms: %d, completion%%: %d", lenMs, playedMs, playedPct)

#define LOG_AUDIO_PLAY_DONE(lenMs, playedMs, playedPct) \
          logEvtFmt(AUDIO_EVENT, "evt: done, length_ms: %d, played_ms: %d, completion%%: %d", lenMs, playedMs, playedPct)

#define LOG_AUDIO_PLAY_JUMP(lenMs, playedMs, adjustMs ) \
          logEvtFmt(AUDIO_EVENT, "jump: %s, length_ms: %d, played_ms: %d, skip_ms: %d", adjustMs<0?"back":"ahead", lenMs, playedMs, adjustMs)
