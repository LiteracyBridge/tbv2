...
#define GPIO_DEFINITION_LIST \
    GPIO_DEFINITION( HOME,              GPIOA,  0, GDEF_NONE ) \
    GPIO_DEFINITION( CIRCLE,            GPIOE,  9, GDEF_NONE ) \
    GPIO_DEFINITION( PLUS,              GPIOA,  4, GDEF_NONE ) \
    GPIO_DEFINITION( MINUS,             GPIOA,  5, GDEF_NONE ) \
    GPIO_DEFINITION( TREE,              GPIOA, 15, GDEF_NONE ) \
    GPIO_DEFINITION( LHAND,             GPIOB,  7, GDEF_NONE ) \
    GPIO_DEFINITION( RHAND,             GPIOB, 10, GDEF_NONE ) \
    GPIO_DEFINITION( POT,               GPIOC,  1, GDEF_NONE ) \
    GPIO_DEFINITION( STAR,              GPIOE,  8, GDEF_NONE ) \
    GPIO_DEFINITION( TABLE,             GPIOE,  3, GDEF_NONE ) \
    GPIO_DEFINITION( RED,               GPIOE,  1, GDEF_NONE ) \
    GPIO_DEFINITION( GREEN,             GPIOE,  0, GDEF_NONE ) \
    GPIO_DEFINITION( BOARD_REV,         GPIOB,  0, GDEF_NONE ) \
    GPIO_DEFINITION( ADC_LI_ION,        GPIOA,  2, GDEF_NONE ) \
    GPIO_DEFINITION( ADC_PRIMARY,       GPIOA,  3, GDEF_NONE ) \
    GPIO_DEFINITION( ADC_THERM,         GPIOC,  2, GDEF_NONE ) \
    GPIO_DEFINITION( PWR_FAIL_N,        GPIOE,  2, GDEF_NONE ) \
    GPIO_DEFINITION( ADC_ENABLE,        GPIOE, 15, GDEF_NONE ) \
    GPIO_DEFINITION( SC_ENABLE,         GPIOD,  1, GDEF_NONE ) \
    GPIO_DEFINITION( EN_IOVDD_N,        GPIOE,  4, GDEF_NONE ) \
    GPIO_DEFINITION( EN_AVDD_N,         GPIOE,  5, GDEF_NONE ) \
    GPIO_DEFINITION( EN_5V,             GPIOD,  4, GDEF_NONE ) \
    GPIO_DEFINITION( EN1V8,             GPIOD,  5, GDEF_NONE ) \
    GPIO_DEFINITION( 3V3_SW_EN,         GPIOD,  6, GDEF_NONE ) \
    GPIO_DEFINITION( EMMC_RSTN,         GPIOE, 10, GDEF_NONE ) \
    GPIO_DEFINITION( BAT_STAT1,         GPIOD,  8, GDEF_NONE ) \
    GPIO_DEFINITION( BAT_STAT2,         GPIOD,  9, GDEF_NONE ) \
    GPIO_DEFINITION( BAT_PG_N,          GPIOD, 10, GDEF_NONE ) \
    GPIO_DEFINITION( BAT_CE,            GPIOD,  0, GDEF_NONE ) \
    GPIO_DEFINITION( BAT_TE_N,          GPIOD, 13, GDEF_NONE ) \
    GPIO_DEFINITION( BOOT1_PDN,         GPIOB,  2, GDEF_NONE ) \
    GPIO_DEFINITION( I2C1_SCL,          GPIOB,  8, GDEF_AF_4 ) \
    GPIO_DEFINITION( I2C1_SDA,          GPIOB,  9, GDEF_AF_4 ) \
    GPIO_DEFINITION( I2S2_SD,           GPIOB, 15, GDEF_AF_5 ) \
    GPIO_DEFINITION( I2S2ext_SD,        GPIOB, 14, GDEF_AF_6 ) \
    GPIO_DEFINITION( I2S2_WS,           GPIOB, 12, GDEF_AF_5 ) \
    GPIO_DEFINITION( I2S2_CK,           GPIOB, 13, GDEF_AF_5 ) \
    GPIO_DEFINITION( I2S2_MCK,          GPIOC,  6, GDEF_AF_5 ) \
    GPIO_DEFINITION( I2S3_MCK,          GPIOC,  7, GDEF_AF_6 ) \
    GPIO_DEFINITION( SPI4_NSS,          GPIOE, 11, GDEF_AF_5 ) \
    GPIO_DEFINITION( SPI4_SCK,          GPIOE, 12, GDEF_AF_5 ) \
    GPIO_DEFINITION( SPI4_MISO,         GPIOE, 13, GDEF_AF_5 ) \
    GPIO_DEFINITION( SPI4_MOSI,         GPIOE, 14, GDEF_AF_5 ) \
    GPIO_DEFINITION( USB_DM,            GPIOA, 11, GDEF_AF_10 ) \
    GPIO_DEFINITION( USB_DP,            GPIOA, 12, GDEF_AF_10 ) \
    GPIO_DEFINITION( USB_ID,            GPIOA, 10, GDEF_AF_10 ) \
    GPIO_DEFINITION( USB_VBUS,          GPIOA,  9, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_CLK_A,        GPIOD,  3, GDEF_AF_9 ) \
    GPIO_DEFINITION( QSPI_CLK_B,        GPIOB,  1, GDEF_AF_9 ) \
    GPIO_DEFINITION( MCO2,              GPIOC,  9, GDEF_AF_0 ) \
    GPIO_DEFINITION( QSPI_BK1_IO0,      GPIOD, 11, GDEF_AF_9 ) \
    GPIO_DEFINITION( QSPI_BK1_IO1,      GPIOD, 12, GDEF_AF_9 ) \
    GPIO_DEFINITION( QSPI_BK1_IO2,      GPIOC,  8, GDEF_AF_9 ) \
    GPIO_DEFINITION( QSPI_BK1_IO3,      GPIOA,  1, GDEF_AF_9 ) \
    GPIO_DEFINITION( QSPI_BK1_NCS,      GPIOB,  6, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_BK2_IO0,      GPIOA,  6, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_BK2_IO1,      GPIOA,  7, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_BK2_IO2,      GPIOC,  4, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_BK2_IO3,      GPIOC,  5, GDEF_AF_10 ) \
    GPIO_DEFINITION( QSPI_BK2_NCS,      GPIOC, 11, GDEF_AF_9 ) \
    GPIO_DEFINITION( SDIO_DAT0,         GPIOB,  4, GDEF_AF_12 ) \
    GPIO_DEFINITION( SDIO_DAT1,         GPIOA,  8, GDEF_AF_12 ) \
    GPIO_DEFINITION( SDIO_DAT2,         GPIOC, 10, GDEF_AF_12 ) \
    GPIO_DEFINITION( SDIO_DAT3,         GPIOB,  5, GDEF_AF_12 ) \
    GPIO_DEFINITION( SDIO_CLK,          GPIOC, 12, GDEF_AF_12 ) \
    GPIO_DEFINITION( SDIO_CMD,          GPIOD,  2, GDEF_AF_12 ) \
    GPIO_DEFINITION( SWDIO,             GPIOA, 13, GDEF_NONE ) \
    GPIO_DEFINITION( SWCLK,             GPIOA, 14, GDEF_NONE ) \
    GPIO_DEFINITION( SWO,               GPIOB,  3, GDEF_NONE ) \
    GPIO_DEFINITION( OSC32_OUT,         GPIOC, 15, GDEF_NONE ) \
    GPIO_DEFINITION( OSC32_IN,          GPIOC, 14, GDEF_NONE ) \
    GPIO_DEFINITION( OSC_OUT,           GPIOH,  1, GDEF_NONE ) \
    GPIO_DEFINITION( OSC_IN,            GPIOH,  0, GDEF_NONE ) \
